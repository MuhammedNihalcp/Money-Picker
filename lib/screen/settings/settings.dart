...
class _ScreenSettingsState extends State<ScreenSettings> {
  ...
  final transactionCT = Get.put(TransactionController());
  final categoryCT = Get.put(CategoryController());

  Future<void> restartApp(BuildContext context) async {
    transactionCT.restartTransaction();
    categoryCT.resetCategory();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      final Uri url =
                          Uri.parse('https://www.instagram.com/nihal__c__p/');
                      if (!await launchUrl(url)) {
                        throw 'Could not launch $url';
                      }
                    },
